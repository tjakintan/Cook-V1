      ...
      <>
          ...
          <div className=" fixed inset-0 z-20 flex items-center justify-center p-2 pointer-events-auto" onClick={() => navigate("/")}>
            ...
            >
              ...
              >
                  <span htmlFor="email" className={`block text-md text-[25px] font-light tracking-widest ${showSignUp ? "hidden" : ""}`}>
                      Email
                  </span>
                  <span htmlFor="email" className={`block text-[20px] font-light tracking-wider ${showSignUp ? "" : "hidden"}`}>
              ...
              >
                  ...
                  <a className={`mt-1 text-[10px] font-thin tracking-widest hover:text-blue-400 cursor-pointer ${passcodeIncorrect ? "hidden" : ""}`}
