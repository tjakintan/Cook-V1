            ...
            {dish_steps.map((step, idx) => (
                ...
                <motion.div 
                    ...
                    className={`rounded-[40px] bg-white shadow-xl shadow-lg flex overflow-hidden 
                                items-center justify-center py-2 gap-5`}
                ...
                >
                    ...
                    <div className={`${showTimer[idx] ? "hidden" : ""} min-w-[250px] h-[30px] flex cursor-pointer`}>

                        <div className="w-[50px] h-full bg-pink-600">
                    ...
                    {showTimer[idx] && (
                        <div className="w-full flex items-center justify-center p-5">
                            <div className="w-full h-[200px] bg-gray-100 flex flex-col items-start justify-center rounded-[30px] overflow-hidden space-y-2 px-3 py-2">
                                ...
                                <button 
                                    className={`px-5 h-2/5 cursor-pointer text-white tracking-widest font-light
