...
const DishInfo = ({ value, onPassToHead }) => {
    ...
    return (
        <div className="flex items-center justify-center ">
            ...
            <div ref={containerRef} className="relative w-full h-screen overflow-y-auto flex scrollbar-hide  ">
                <motion.div 
                    className="absolute w-full gap-5 flex flex-col justify-center bg-red-300 " 
                    drag="y" 
                    dragConstraints={{ top: -sectionHeight * 3, bottom: 0 }}
                    dragElastic={0.2} 
                    onDragEnd={(event, info) => { 
                        if (info.offset.y < -5) nextPage(); 
                        if (info.offset.y > 5) prevPage(); 
                    }} 
                ...
                >
                    ...
                    {/* Page 1: Image Upload */}
                        ...
                        <div style={{ height: sectionHeight }} className="h-screen flex flex-shrink-0 items-center justify-center bg-orange-300">
                            <div 
                                {...getRootProps()}
                    ...
                    {/* Page 2: Dish Name */}
                        ...
                        <div style={{ height: sectionHeight }} className={`flex-shrink-0 flex items-center justify-center text-2xl bg-blue-300`}>
                    ...
                    {/* Page 3: Dish Description */}
                        ...
                        <div style={{ height: sectionHeight }} className={`flex-shrink-0 flex items-center justify-center text-2xl bg-cyan-400`}>
                            <div className="flex flex-col overflow-hidden p-5 gap-10">
                    ...
                    {/* Page 4: Dish Difficulty */}
                        ...
                        <div style={{ height: sectionHeight }} className={`flex-shrink-0 flex items-center justify-center text-2xl bg-purple-400`}>
                            <div className="flex flex-col overflow-hidden p-5 gap-10">
                                <h1 className="text-center tracking-widest font-bold text-[50px]">
