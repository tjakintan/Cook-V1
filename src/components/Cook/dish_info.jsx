...
import WobblyText from "../../hooks/wobbyText";
                ...
                >
                    <div 
                        ...
                        className={`w-full h-full flex flex-col flex-shrink-0
                                    flex items-center justify-center gap-10 rounded-[30px]
                        ...
                        <div className="flex flex-col font-thin items-center justify-center text-center">
                            <h1 className="text-[25px] tracking-wider">
                    ...
                    <div className={`w-full h-full flex-shrink-0 p-5 flex items-center justify-center text-2xl`}>
                        <div className="w-full h-full flex flex-col overflow-hidden p-5 gap-5">
                            ...
                            <motion.div 
                                className="h-full bg-yellow-300 rounded-[30px] py-20 px-5"
                                whileHover={{ scale: 1.05 }} 
                                transition={{ type: "spring", stiffness: 300, damping: 20 }} 
                            >
                                <textarea 
                                    value={dish_name}
                                    onChange={(e) => {setDish_name(e.target.value); nextPage();}}
                    ...
                    <div className={`w-full h-full flex-shrink-0 p-5 flex items-center justify-center text-2xl`}>
                        <div className="w-full h-full flex flex-col overflow-hidden p-5 gap-5">
                            ...
                            <motion.div 
                                className="h-full bg-blue-300 rounded-[30px]"
                                whileHover={{ scale: 1.05 }} 
                                transition={{ type: "spring", stiffness: 300, damping: 20 }} 
                            >
                    ...
                    <div className={`w-full h-full flex-shrink-0 p-5 flex items-center justify-center text-2xl`}>
                        <div className="flex flex-col overflow-hidden p-5 gap-5">
                            <h1 className="text-center tracking-widest font-bold text-[50px]">
