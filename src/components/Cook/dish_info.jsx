...
const DishInfo = ({ value, onPassToHead }) => {
    ...
    return (
        ...
        <div className="flex items-center">
            ...
            <div ref={containerRef} className={`min-h-[100vh] w-full flex flex-col justify-end pt-10`}>
                
                <div className={`${showFullImgPreview ? "hidden" : ""} flex flex-col`}>
                    
                    {dish_image_url && !isLoading && (
                        <div className={`h-[30vh] z-30 flex justify-center items-end`}>
                        <motion.div
                            whileHover={{ scale: 1.01 }}
                            whileTap={{ scale: 0.92 }}   
                            onClick={() => setShowFullImgPreview(true)}
                            className={`rounded-[40px]
                                        rounded-[30px] bg-gray-100 opacity-70 hover:opacity-100 w-full h-[100px] md:h-[200px] flex items-center 
                    ...
                    <div className={`z-10 w-full h-[70vh] flex items-center justify-center overflow-auto scrollbar-hide`}>
                        ...
                        <motion.div 
                            ...
                            className={`w-full h-full flex flex-row ${dish_image_url ? "items-center" : "items-start"} py-1 justify-start`} 
                        ...
                        >
                            ...
                            <div style={{ minWidth: containerWidth }} className="max-w-[90vw] flex flex-shrink-0 items-center justify-center">
                                ...
                                >
                                    ...
                                    <div className={`${isLoading || notSupportedFile ? "hidden" : ""} flex`}>
                ...
                {showFullImgPreview && (
                    <div className="absolute w-screen h-screen bg-blue-300" onClick={() => setShowFullImgPreview(false)}>
                        <img
                            src={dish_image_url}
                            alt={dish_name}
