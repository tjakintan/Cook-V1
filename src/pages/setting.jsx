...
function Header({ passToHeadClick }) {
    ...
    return (
        <>
            ...
            <div className="relative px-2 py-1 w-full md:w-2/3 flex items-center justify-between">
                ...
                <div ref={containerRef} className={`flex py-3 gap-5 bg-white/30 backdrop-blur-lg
                ...
                <div className="flex gap-6">
                    ...
                    {/* Settings Button */}
                    <button className="flex cursor-pointer mr-2" onClick={passToHeadClick}>
...
export default function Settings({isOpen, toggleOpen }) {
    ...
    return (
        <div className={`flex flex-col items-center justify-between`}>
            ...
            <div className={`max-w-full md:max-w-2/3 pt-0 flex items-center bg-orange-300
                            ${isOpen ? "h-[40vh]" : "hidden"}
                            ${showAccountUpdateSection ? "h-[75vh]" : ""}`}>
                
                <div className={`w-full h-full flex flex-col px-5 py-5 gap-5 justify-between ${showAccountUpdateSection ? "hidden" : ""}`}>
                    ...
                    <div className="w-full flex flex-col h-2/5 bg-red-300">
                        <div className="w-full flex gap-2">
                            <svg 
                                ...
                                viewBox="0 0 16 16"
                            >
                                <path fill="#000000" fill-rule="evenodd" d="m14.489 8.388l-.001.006a.115.115 0 0 1-.027.028a.428.428 0 0 1-.264.082h-3.186c-3.118 0-4.68 3.77-2.476 5.974a6.5 6.5 0 1 1 5.953-6.09Zm-.292 1.616c.913 0 1.736-.618 1.79-1.529a8 8 0 1 0-7.032 7.468c1.243-.147 1.527-1.639.641-2.525c-1.26-1.26-.367-3.414 1.415-3.414h3.186ZM10 5a1 1 0 1 1-2 0a1 1 0 0 1 2 0ZM6 7a1 1 0 1 0 0-2a1 1 0 0 0 0 2Zm0 2a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z" clip-rule="evenodd"
                                />
                            </svg>
                        </div>
                        <div className="">
                            <button
                            onClick={() => {setIsDark(!isDark); console.log("clicked")}}
                    ...
                    <div className="w-full flex flex-col gap-3">
                        <div className="w-full flex py-1 gap-2">
                        ...
                        <div  
                            className={`${!user ? "" : "opacity-30 pointer-events-none"}
                                        rounded-xl flex flex-row justify-start items-start gap-5 p-1 overflow-auto scrollbar-hide`}>
                            ...
                            <MenuButton
                                ...
                                icon={
                                    <svg 
                                        className="w-6 h-6" 
                                        viewBox="0 0 16 17">
                                        <path fill-rule="evenodd" d="M12 9V7H8V5h4V3l4 3l-4 3zm-2 3H6V3L2 1h8v3h1V1c0-.55-.45-1-1-1H1C.45 0 0 .45 0 1v11.38c0 .39.22.73.55.91L6 16.01V13h4c.55 0 1-.45 1-1V8h-1v4z" fill="#000000"/>
                                    </svg>
                                }
            ...
            <Header passToHeadClick={toggleOpen}/>
