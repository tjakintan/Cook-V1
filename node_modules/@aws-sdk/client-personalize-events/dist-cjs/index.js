...
// src/PersonalizeEventsClient.ts
var PersonalizeEventsClient = class extends import_smithy_client.Client {
  static {
    __name(this, "PersonalizeEventsClient");
  }
  /**
...
// src/models/models_0.ts
var InvalidInputException = class _InvalidInputException extends PersonalizeEventsServiceException {
  static {
...
var ResourceInUseException = class _ResourceInUseException extends PersonalizeEventsServiceException {
  static {
...
var ResourceNotFoundException = class _ResourceNotFoundException extends PersonalizeEventsServiceException {
  static {
...
var PutActionsCommand = class extends import_smithy_client.Command.classBuilder().ep(commonParams).m(function(Command, cs, config, o) {
  return [
    (0, import_middleware_serde.getSerdePlugin)(config, this.serialize, this.deserialize),
    (0, import_middleware_endpoint.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
  ];
...
var PutItemsCommand = class extends import_smithy_client.Command.classBuilder().ep(commonParams).m(function(Command, cs, config, o) {
  return [
    (0, import_middleware_serde.getSerdePlugin)(config, this.serialize, this.deserialize),
    (0, import_middleware_endpoint.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
  ];
...
var PutUsersCommand = class extends import_smithy_client.Command.classBuilder().ep(commonParams).m(function(Command, cs, config, o) {
  return [
    (0, import_middleware_serde.getSerdePlugin)(config, this.serialize, this.deserialize),
    (0, import_middleware_endpoint.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
  ];
...
var PersonalizeEvents = class extends PersonalizeEventsClient {
  static {
    __name(this, "PersonalizeEvents");
  }
};
